...
print(predict_num, method, holiday_method, regression_method, changepoint_method)
print(mark)
...
# Зберігаємо данні роботи у журнал
    first_str="Error;Start;End;Mark;Metod;Predict_num;Changepoint_range;Changepoint_prior_scale;yearly_seasonality;weekly_seasonality;daily_seasonality;growth;n_changepoints;changepoints;seasonality_mode;seasonality_prior_scale;mcmc_samples;interval_width;uncertainty_samples;stan_backend;holidays;holidays_prior_scale"
